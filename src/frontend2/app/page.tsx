...
export default async function Index() {
  ...
  return (
    <div className="flex-1 w-full flex flex-col gap-20 items-center">
      ...
      <div className="hero flex-1 flex flex-col gap-20 max-w-4xl px-3 h-screen justify-center">
        <Header/>
        <p> Please sign in or create an account at the top right to get started </p>
      </div>
